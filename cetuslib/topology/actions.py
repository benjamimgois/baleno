"""Context-menu actions that invoke other Cetus modules from the topology map.

The topology canvas knows each node's IP and role.  This module turns that into
one-click access to the other Cetus tools (terminal, IP scanner, SNMP, file
...
from cetuslib.utils import load_svg_icon_dual
