"""Automation tab UI for Baleno — mass command execution over SSH/Telnet."""
...
from balenolib.automation_worker import (
    MAX_TARGETS,
    STATUS_PENDING, STATUS_RUNNING, STATUS_OK,
    STATUS_ERROR, STATUS_TIMEOUT, STATUS_CANCELLED,
    parse_targets, AutomationManager,
)
from balenolib.ui.widgets import FlatComboButton
from balenolib.vendors import VENDOR_MENU
    ...
    def _save_as(self, log_path):
        ...
        if dest:
            try:
                ...
                QMessageBox.warning(self, 'Baleno', f'Failed to save: {exc}')
...
class AutomationTab(QWidget):
    ...
    def _build_connection_group(self):
        ...
        self.remember_cb.setToolTip(
            'Stores the username and password in the Baleno settings.\n'
