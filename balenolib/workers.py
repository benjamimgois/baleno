                ...
                if any(msg in stderr_output for msg in (
                    ...
                    if self.method in ('TCP', 'UDP'):
                        self.route_error.emit(f"{self.method} traceroute requires root privileges.\n\n"
                                             f"Run Baleno with: sudo python3 baleno\n"
    ...
    def run(self):
        ...
        while self._running:
            ...
            try:
                ...
                req = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0 Baleno'})
