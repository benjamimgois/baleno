"""Workers for the Baleno Automation module (mass command execution over SSH/Telnet)."""
...
class AutomationManager(QThread):
    ...
    # ------------------------------------------------------------------ #
    def _run_dir(self):
        base = Path.home() / '.local' / 'share' / 'baleno' / 'automation'
